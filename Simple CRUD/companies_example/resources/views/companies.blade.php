...
<head>
    <meta charset="UTF-8">
    <title>Laravel 9 AJAX CRUD using DataTable</title>
    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2>Laravel 9 AJAX CRUD using DataTable</h2>
                </div>
        ...
        @endif
        <div class="card-body">
            <table class="table table-bordered" id="companies_datatable">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
    ...
    function deleteFunc(id) {
        if (confirm("Delete Record?") == true) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(res) {
                    var oTable = $('#companies_datatable').dataTable();
                    oTable.fnDraw(false);
                }
            });
        }
